...
/* Watchdog configuration - this is 12MSB of 24-bit value with 12bit LSB always set to 0xFFF
 * at hardware level, for 100MHz, 0.01us * 512 * (0xFFFFFF+1) ~= 85.9s
 */
#define WATCHDOG_TIMEOUT 0xFFFU

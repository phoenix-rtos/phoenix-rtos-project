...
/* Kernel locations in FLASH, list terminated with value smaller than preceeding one. */
#define FLASH_KERNEL_OFFSETS	{0x20000, 0}

#define MMCBLK_KERNEL_OFFSET	(3 * 512)
...
#define DEFAULT_CMD				"load auto; go!; reset"
#define DEFAULT_KERNEL_ARGS		"WDOG=yes"

#define MMCBLK_ENABLED			1

/* R    G    B  */
#define STATUS_LEDS				{ 111, 127, 85 }
#define STATUS_LEVEL			{ 1, 0, 1 }

#define WATCHDOG_ENABLED		1
#define WATCHDOG_TIMEOUT_SEC	120

#define CONFIG_CONSOLE_RAW

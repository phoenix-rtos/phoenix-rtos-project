...
class STM32N6Flasher:
    ...
    def __init__(self, scripts_dir: Path, boot_dir: Path, adapter_speed: Optional[int] = None) -> None:
        ...
        plo_path = self.boot_dir / self.PLO_FILENAME
...
def flasher_file_action(args):
    ...
    total_size = 0
    with STM32N6Flasher(args.scripts_dir, args.boot_dir, args.adapter_speed) as flasher:
